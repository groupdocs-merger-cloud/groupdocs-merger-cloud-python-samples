...
class Common:
    ...
    @classmethod  
    def GetConfig(cls):
        configuration = groupdocs_merger_cloud.Configuration(cls.client_id, cls.client_secret)
    ...
    def UploadSampleFiles(cls):
        ...
        # api initialization
        storageApi = groupdocs_merger_cloud.StorageApi.from_config(cls.GetConfig())
        fileApi = groupdocs_merger_cloud.FileApi.from_config(cls.GetConfig())
